...
#ifndef POKEMONROCHE_H
#define POKEMONROCHE_H

#include "Pokemon.h"

class PokemonRoche : public Pokemon {
public:
    PokemonRoche(std::string n, int h, std::string a, int p)
        : Pokemon(n, {"Roche"}, h, a, p) {}
